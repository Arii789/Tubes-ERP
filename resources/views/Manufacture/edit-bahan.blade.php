        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('/Manufacture/bahan') }}">Manufacturing</a></li>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ url('/home/bahan/update/' . $bahan->id) }}" method="post"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" name="gambar" id="gambar" class="form-control"
                                            value="{{ asset('/img_bahan/' . $bahan->gambar) }}" style="max-width: 5rem;">
                                    </div>
                                </div>
                                <div class="col-12">
