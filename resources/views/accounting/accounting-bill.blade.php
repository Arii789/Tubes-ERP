          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table datatable" id="myTable">
                <div class="card-body">
                <a href="/accounting-bill"><button type="button" class="btn btn-success">Tampilkan Semua Data</button></a>
                <a href="/accounting-bill/cetak/" target="_blank"><button type="button" class="btn btn-primary">Cetak Laporan</button></a>
                ...
                <div class="row mb-3">
                  ...
                  <br>
                  <br>
                  <a href="" onclick="this.href='/accounting-bill/tampil-pertanggal/'+ document.getElementById('tglawal').value + '/' + document.getElementById('tglakhir').value" class="btn btn-secondary">Tampilkan Data Per Tanggal</a>
                </div>
                ...
                <tbody>
                  ...
                  @if($item->status > 4)
                    <tr>
                      ...
                      <td>
                        @if($item->status >= 5 )
                        <a href="{{ url('po-invoice/'.$item->kode_rfq) }}" target="_blank"><span class="badge bg-info text-dark">Cek Invoice</span></a>
                        @endif
                      </td>
                    </tr>
                  @endif
