    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="{{ url('/accounting-invoicing') }}">Customer Invoicing</a>  <a>OR <a href="{{ url('/accounting-bill') }}">Vendor Bill</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
                ...
                <tbody>
                  ...
                  @if($item->status > 4)
                    <tr>
                      ...
                      <td>
                        @if($item->status >= 3 )
                        <a href="{{ url('so-invoice/'.$item->kode_sq) }}" target="_blank"><span class="badge bg-info text-dark">Cek Invoice</span></a>
                        @endif
                      </td>
                    </tr>
                  @endif
