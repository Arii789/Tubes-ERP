          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Tambah Data Item Bill of Material</h5>
                ...
                <form action="{{ url('bom/input-item-bom')}}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row mb-3">
                ...
                <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="simpan">Insert</button>
                </div>
                ...
                <tbody>
                  ...
                  @foreach($list as $item)
                    <tr>
                      ...
                      <td>
                      <td>
                          <a href="{{ url('bom/bom-delete-item/'.$item->kode_bom_list) }}"><span class="badge bg-success"> Hapus</span></a>
                      </td>
                    </tr>
                    @endforeach
                    @else
