                    ...
                    <div class="card w-100"> <!-- Menambahkan kelas w-100 untuk lebar penuh --> --}}
                        {{-- <div class="card-body">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="chart-bar"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><canvas id="myBarChart" width="0" height="1" style="display: block; width: 100px; height: 200px;" class="chartjs-render-monitor"></canvas></div>
                                </div>
