        ...
        <div class="col-lg-12">
                ...
                <tbody>
                  ...
                  @foreach($rfqList as $item)
                    <tr>
                      ...
                      @if($rfq->status == 1)
                      <td>
                          <a href="{{ url('rfq-delete-item/'.$item->kode_rfq_list) }}"><span class="badge bg-success"> Hapus</span></a>
                      </td>
                      @else
                        <td>
          ...
          <div class="card">
            <div class="card-body">
              ...
              @endif
                @if($rfq->status == 1 )
                <form action="{{ url('po/savePo') }}" method="post" class="btn p-0" name="input-form" id="input-form">
                    {{ csrf_field() }}
                ...
                @elseif($rfq->status == 4)
                <form action="{{ url('po/create-bill') }}" method="post" class="p-0" name="input-form" id="input-form">
                    {{ csrf_field() }}
                ...
                <br>
                <button type="submit" class="btn btn-dark"><a href="{{ url('po-invoice/'.$rfq->kode_rfq) }}" target="_blank" class="text-white">Lihat Invoice</a></button>
                @endif
            </div>
          </div>
