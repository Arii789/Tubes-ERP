        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ url('/po') }}"> Purchase Orders</a></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                                        ...
                                        @foreach ($rfqs as $item)
                                            @if ($item->status > 1)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('po-input-item/' . $item->kode_rfq) }}"><span
                                                                class="badge bg-success"> Edit</span></a>
                                                        @if ($item->status >= 5)
                                                            <a href="{{ url('po-invoice/' . $item->kode_rfq) }}"
                                                                target="_blank"><span class="badge bg-info text-dark">
                                                                    Invoice</span></a>
                                                        @endif
                                                    </td>
                                                </tr>
