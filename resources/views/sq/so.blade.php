                ...
                <tbody>
                  ...
                  @if($item->status >1)
                    <tr>
                      ...
                      <td>
                        <a href="{{ url('so-input-item/'.$item->kode_sq) }}"><span class="badge bg-success"> Edit</span></a>
                        @if($item->status >= 3 )
                        <a href="{{ url('so-invoice/'.$item->kode_sq) }}" target="_blank"><span class="badge bg-info text-dark"> Invoice</span></a>
                        @endif
                      </td>
                    </tr>
                  @endif
