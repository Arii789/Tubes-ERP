                ...
                <tbody>
                  ...
                  @foreach($sqs as $item)
                    <tr>
                      ...
                      <td>
                        <a href="{{ url('sq-input-item/'.$item->kode_sq) }}"><span class="badge bg-success"> Edit</span></a>
                        <a href="{{ url('sq-delete/'.$item->kode_sq) }}"><span class="badge bg-danger"> Hapus</span></a>
                      </td>
                    </tr>
                  @endforeach
                  @else
